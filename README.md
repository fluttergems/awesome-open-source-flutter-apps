...
| Cinema Booking | [Link](https://github.com/ChunhThanhDe/cinema-booking) | A Completed Functional Flutter app for booking movie tickets, built with Flutter Clean Template, BLoC, REST API, Firebase Auth, and Unit Tests. |
